...
#images1=np.load('photos/beta_data_56/codes_beta_pool3_2w.npy')
images2=np.load('photos/beta_data_56/codes_beta_pool2_4w.npy')
images3=np.load('photos/beta_data_56/codes_beta_pool2_6w.npy')
#images4=np.load('photos/beta_data_56/codes_beta_pool3_8w.npy')
...
images=np.concatenate((images2,images3))
#images= images[19000:21000]

labels=labels[20000:60000]
(l,w,h)=(56,56,128)
labels_train = labels
...
h_conv3_1=conv_add_layer(x_image,h,256,1,activation_function=tf.nn.relu,strides=[1, 1, 1, 1],padding='SAME')[0] 
...
#h_pool1 = Batch_Norm_(h_conv1,1,out_size=[14,14,512])
...
'''
h_conv1=conv_add_layer(x_image,h,256,1,activation_function=tf.nn.relu,strides=[1, 1, 1, 1],padding='SAME')[0] 
h_pool1 = Batch_Norm_(h_conv1,1,out_size=[14,14,256])
h_pool1 = max_pool_2x2(h_pool1)

h_conv2=conv_add_layer(h_pool1,256,256,2,activation_function=tf.nn.relu,strides=[1, 1, 1, 1],padding='SAME')[0] 

h_pool2 = max_pool_2x2(h_conv2) 

'''
#h_pool2 = Batch_Norm_(h_conv2,2,out_size=[4,4,512])
'''
...
h_pool4_flat = tf.reshape(h_pool5, [-1, 7*7*512])
...
for i in range(3500):
    ...
    train_images1,train_labels1=batch_data.next_batch( batch_size=64)
...
saver.save(sess, "beta_try_4/pool2/pool2.ckpt")
...
np.save('beta_try_4/pool2/compute_accuracy_x',compute_accuracy(images_test,labels_test)[1])
np.save('beta_try_4/pool2/compute_accuracy_y',compute_accuracy(images_test,labels_test)[2])
np.save('beta_try_4/pool2/compute_accuracy_acc',compute_accuracy(images_test,labels_test)[0])

np.save('beta_try_4/pool2/train_loss_',train_loss_)
np.save('beta_try_4/pool2/val_loss_',val_loss_)
...
print(test_proba)
test_proba.to_csv('beta_try_4/pool2/pool2_submission.csv', index=False, float_format='%.6f')
...
plt.savefig("beta_try_4/pool2/val_train_pool2.jpg")